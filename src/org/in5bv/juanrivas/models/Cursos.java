...
public class Cursos {
   ...
   private StringProperty salonId;
    ...
    // Para los metodos getter y setter si se trabaja como lo de arriba 
    // esta mal, esto se debe hacer maualmente
    
     
    public Cursos(int id, String nombreCurso, int ciclo, int cupoMaximo, int cupoMinimo, String carreraTecnicaId, int horarioId, int instructortId, String salonId) {
        ...
        this.instructorId = new SimpleIntegerProperty(instructortId);
        this.salonId = new SimpleStringProperty(salonId);
    }   
    
    // Creando los Getter´s and Setter´s
