...
public class Principal extends Application {
    ...
    public void mostrarEscenaCarreras() {
        try {
            CarrerasTecnicasController carrerasController = (CarrerasTecnicasController) cambiarEscena("CarrerasTecnicasView.fxml", 1280, 600);
    ...
    public void mostrarEscenaPrincipal() {
        try {
            MenuPrincipalController menuController = (MenuPrincipalController)cambiarEscena("MenuPrincipalView.fxml", 1280, 600);
    ...
    public void mostarEscenaAsignacionesAlumnos() {
        try{
            AsignacionesAlumnosController asignacionController = (AsignacionesAlumnosController) cambiarEscena("AsignacionesAlumnosView.fxml", 1280, 600);
    ...
    public void mostarEscenaCursos(){
        try {
            CursosController cursoController = (CursosController) cambiarEscena("CursosView.fxml", 1280, 600);
    ...
    public void mostrarEscenaInstructores(){
        try {
            InstructoresController instructorController = (InstructoresController) cambiarEscena("InstructoresView.fxml", 1431, 586);
